...
/// Use case to get total expenses for the current day.
class GetDailyExpense implements BaseUsecase<double, NoParams> {
  final BaseWalletRepository repository;

  GetDailyExpense(this.repository);

  @override
  Future<Either<BaseFailure, double>> call(NoParams params) {
    return repository.getDailyExpense();
  }
}
