...
/// Use case to get total expenses for the current week.
class GetWeeklyExpense implements BaseUsecase<double, NoParams> {
  final BaseWalletRepository repository;

  GetWeeklyExpense(this.repository);

  @override
  Future<Either<BaseFailure, double>> call(NoParams params) {
    return repository.getWeeklyExpense();
  }
}
